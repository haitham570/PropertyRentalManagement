...
namespace Final_Property_Rental.Controllers
{
    public class PropertyOwnersController : Controller
    {
        ...
        {
            var propertyOwners = db.PropertyOwners.Include(p => p.User);
        ...
        public ActionResult Create([Bind(Include = "OwnerId,UserId,FirstName,LastName")] PropertyOwner propertyOwner)
        {
            ...
            ViewBag.UserId = new SelectList(db.Users, "ID", "UserName", propertyOwner.UserId);
            return View(propertyOwner);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OwnerId,UserId,FirstName,LastName")] PropertyOwner propertyOwner)
        {
            if (ModelState.IsValid)
            {
